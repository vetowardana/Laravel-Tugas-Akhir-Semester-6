...
@section('title')
	<title>MagangKUY - Manajemen Lowongan Selesai</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Manajemen Lowongan Selesai</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
            <li class="breadcrumb-item active">Manajemen Lowongan Selesai</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $s->status }}</td>
                        <td>
                          <a href="{{ route('lowonganselesai.show', $s->id) }}"><button type="button" class="btn btn-info btn-sm">Detail</button></a>
                          <form action="{{ route('lowonganselesai.destroy', $s->id) }}" method="post">
                            @csrf
                            @method('DELETE')
