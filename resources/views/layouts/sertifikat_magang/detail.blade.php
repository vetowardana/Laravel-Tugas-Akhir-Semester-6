      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('sertifikatmagang.index')}}">Sertifikat Magang</a></li>
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $t->status }}</td>
                        <td>
                          <a href="{{route('buatsertifikat', $t->id)}}"><button type="button" class="btn btn-info">Sertifikat</button></a>
                        </td>
                      </tr>
                      @empty
                      <tr>
