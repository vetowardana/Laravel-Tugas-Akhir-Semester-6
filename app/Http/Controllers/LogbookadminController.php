...
class LogbookadminController extends Controller
{
    public function index() {
    	...
    	return view('layouts.logbook_admin.index',compact('lowongan_selesai','profileadmin'));
    }
    ...
    public function show($id) {
    	...
    	return view('layouts.logbook_admin.detail',compact('lowongan_selesai','profileadmin','pendaftarditerima'));
    }
    ...
    public function lihatLogbook($id) {
    	...
    	return view('layouts.logbook_admin.logbook',compact('pendaftar','profileadmin','logbook','lowongan_selesai'));
    }
    ...
    public function detailLogbook($id) {
    	...
    	return view('layouts.logbook_admin.logbookdetail',compact('pendaftar','profileadmin','logbook','lowongan_selesai'));
    }
}
