...
@section('title')
	<title>MagangKUY - Manajemen Akun Perusahaan</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Manajemen Akun Perusahaan</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
            <li class="breadcrumb-item active">Manajemen Akun Perusahaan</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <section class="col-lg-4 connectedSortable">
          ...
          <div class="card card-light">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('manajemenperusahaan.store')}}" method="post" method="post" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-light">
                <h3 class="card-title">Tabel Akun Perusahaan</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body table-responsive p-0" style="height: 100%; max-height: 700px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $no++ }}</td>
                      <td><img src="{{ asset('storage/user/' . $p->image) }}" style="width: 50px;"></td>
                      <td>{{ $p->name }}</td>
                      <td>{{ $p->email }}</td>
                      <td>
                        <a href="{{ route('manajemenperusahaan.edit', $p->id) }}"><button type="button" class="btn btn-info btn-sm">Edit</button></a>
                        <form action="{{ route('manajemenperusahaan.destroy', $p->id) }}" method="post">
                            @csrf
                            @method('DELETE')
