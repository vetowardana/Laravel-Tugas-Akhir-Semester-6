...
@section('title')
	<title>MagangKUY - Detail Pendaftaran {{ $pendaftar->name }}</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Detail Pendaftaran {{ $pendaftar->name }}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{route('histori.index')}}">Histori Pendaftaran</a></li>
            <li class="breadcrumb-item active">Detail Pendaftaran {{ $pendaftar->name }}</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="card-body">
              <center>
                ...
                <div class="row" style="padding-left: 230px;">
                  ...
                  <div class="col-md-6" style="text-align: left; color: grey;"><p><strong>Program Sudi : </strong>{{ $pendaftar->prodi }}</p></div>
                </div>
                <div class="row" style="padding-left: 230px;">
