...
@section('title')
	<title>MagangKUY - Pendaftar Diterima</title>
@endsection
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Pendaftar Diterima</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
              ...
              <div class="card">
                ...
                <div class="card-body table-responsive p-0" style="height: 100%; max-height: 700px;">
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      @php $no = 1; @endphp
                      @forelse ($pendaftarditerima as $b)
                      <tr>
                        <td>{{ $no++ }}</td>
                        ...
                        <td>{{ $b->status }}</td>
                        <td>
                          <a href="{{route('pendaftarditerima.show', $b->id)}}"><button type="button" class="btn btn-info">Detail</button></a>
                        </td>
                      </tr>
                      @empty
                      <tr>
