...
@section('title')
	<title>MagangKUY - Manajemen Akun Mahasiswa</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Manajemen Akun Mahasiswa</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
            <li class="breadcrumb-item active">Manajemen Akun Mahasiswa</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <section class="col-lg-4 connectedSortable">
          ...
          <div class="card card-light">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form action="{{route('manajemenmahasiswa.store')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="card-body">
              ...
              <div class="card-body table-responsive p-0" style="height: 100%; max-height: 700px;">
                <table class="table table-head-fixed text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $no++ }}</td>
                      <td><img src="{{ asset('storage/user/' . $m->image) }}" style="width: 50px;"></td>
                      <td>{{ $m->name }}</td>
                      <td>{{ $m->email }}</td>
                      <td>
                        <a href="{{ route('manajemenmahasiswa.edit', $m->id) }}"><button type="button" class="btn btn-info btn-sm">Edit</button></a>
                        <form action="{{ route('manajemenmahasiswa.destroy', $m->id) }}" method="post">
                            @csrf
                            @method('DELETE')
