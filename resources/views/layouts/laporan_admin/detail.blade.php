...
@section('title')
	<title>MagangKUY - Laporan Magang {{ $lowongan_selesai->nama_lowongan }}</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Laporan Magang {{ $lowongan_selesai->nama_lowongan }}</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{route('laporanadmin.index')}}">Laporan Magang</a></li>
            <li class="breadcrumb-item active">Laporan Magang {{ $lowongan_selesai->nama_lowongan }}</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $t->status }}</td>
                        <td>
                          <a href="{{route('lihatlaporan', $t->id)}}"><button type="button" class="btn btn-info">Detail</button></a>
                        </td>
                      </tr>
                      @empty
                      <tr>
