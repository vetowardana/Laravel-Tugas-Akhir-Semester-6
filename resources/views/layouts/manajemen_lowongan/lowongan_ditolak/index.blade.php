...
@section('title')
	<title>MagangKUY - Manajemen Lowongan Ditolak</title>
@endsection
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Manajemen Lowongan Ditolak</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('dashboard')}}">Home</a></li>
            <li class="breadcrumb-item active">Manajemen Lowongan Ditolak</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                  ...
                  <table class="table table-head-fixed text-nowrap">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>{{ $t->status }}</td>
                        <td>
                          <a href="{{ route('lowonganditolak.show', $t->id) }}"><button type="button" class="btn btn-info btn-sm">Detail</button></a>
                          <form action="{{ route('lowonganditolak.destroy', $t->id) }}" method="post">
                            @csrf
                            @method('DELETE')
