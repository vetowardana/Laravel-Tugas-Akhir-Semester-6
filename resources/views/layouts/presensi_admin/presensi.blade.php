      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item"><a href="{{route('presensiadmin.index')}}">Presensi</a></li>
            <li class="breadcrumb-item"><a href="{{route('presensiadmin.show', $lowongan_selesai->id)}}">Presensi {{ $lowongan_selesai->nama_lowongan }}</a></li>
